...
Label(frame, text = 'CONTACT BOOK', font='elephant 12 bold',foreground="black").pack(side=TOP)

Label(frame, text = 'Name', font='arial 12 bold',foreground="red").pack(side=LEFT)
Entry(frame, textvariable = Name,width=50).pack()
  
Label(frame1, text = 'Phone No.', font='arial 12 bold',foreground="red").pack(side=LEFT)
Entry(frame1, textvariable = Number,width=50).pack()
  
Label(frame2, text = 'Address', font='arial 12 bold',foreground="red").pack(side=LEFT)
